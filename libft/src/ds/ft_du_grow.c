...
inline t_bool	ft_du8_grow(t_du8 *self, size_t n)
{
	if ((n += self->len + 1) < FT_VEC_MIN_CAP && FT_VEC_MIN_CAP > self->cap)
		return (ft_du8_realloc(self, FT_VEC_MIN_CAP));
	else if (n > self->cap)
...
{
	if ((n += self->len + 1) < FT_VEC_MIN_CAP && FT_VEC_MIN_CAP > self->cap)
		return (ft_du16_realloc(self, FT_VEC_MIN_CAP));
	else if (n > self->cap)
...
{
	if ((n += self->len + 1) < FT_VEC_MIN_CAP && FT_VEC_MIN_CAP > self->cap)
		return (ft_du32_realloc(self, FT_VEC_MIN_CAP));
	else if (n > self->cap)
...
{
	if ((n += self->len + 1) < FT_VEC_MIN_CAP && FT_VEC_MIN_CAP > self->cap)
		return (ft_du64_realloc(self, FT_VEC_MIN_CAP));
	else if (n > self->cap)
...
{
	if ((n += self->len + 1) < FT_VEC_MIN_CAP && FT_VEC_MIN_CAP > self->cap)
		return (ft_deq_realloc(self, FT_VEC_MIN_CAP));
	else if (n > self->cap)
