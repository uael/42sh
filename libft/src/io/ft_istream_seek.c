...
inline t_bool	ft_istream_rewind(t_istream *self, size_t n)
{
	if (self->kind == ISTREAM_FILE)
...
inline t_bool	ft_istream_forward(t_istream *self, size_t n)
{
	if (self->kind == ISTREAM_FILE)
...
inline t_bool	ft_istream_seek(t_istream *self, size_t off)
{
	if (self->kind == ISTREAM_FILE)
