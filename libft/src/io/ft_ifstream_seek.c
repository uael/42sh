...
inline t_bool	ft_ifstream_rewind(t_ifstream *self, size_t n)
{
	(void)self;
	(void)n;
	return (0);
...
inline t_bool	ft_ifstream_forward(t_ifstream *self, size_t n)
{
	(void)self;
	(void)n;
	return (0);
...
inline t_bool	ft_ifstream_seek(t_ifstream *self, size_t off)
{
