...
extern void		*ft_vec_back(t_vec *s);
...
extern uint8_t	*ft_vu8_back(t_vu8 *s);
...
extern uint16_t	*ft_vu16_back(t_vu16 *s);
...
extern uint32_t	*ft_vu32_back(t_vu32 *s);
...
extern uint64_t	*ft_vu64_back(t_vu64 *s);
